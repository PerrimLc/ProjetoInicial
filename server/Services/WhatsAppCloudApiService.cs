...
namespace SaaSAgents.Api.Services
{
    // =====================================================================
    ...
    //   - Phone Number ID e um Access Token (temporário ou permanente via
    //     System User) obtidos no painel do app.
    ...
    {
        // ID do número de telefone cadastrado no WhatsApp Business (painel Meta)
        public string PhoneNumberId { get; set; } = string.Empty;

        // Token de acesso (Bearer) gerado no Meta for Developers
